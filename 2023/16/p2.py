...
def main():
    ...
    print('Result', max([*(fire(input, ((i, -1), (0, 1))) for i in range(len(input[0]))),
                          *(fire(input, ((i, len(input)), (0, -1))) for i in range(len(input[0]))),
                          *(fire(input, ((-1, i), (1, 0))) for i in range(len(input))),
                          *(fire(input, ((len(input[0]), i), (-1, 0))) for i in range(len(input)))
                        ]))
